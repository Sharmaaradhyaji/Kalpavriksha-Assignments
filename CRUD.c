...
void loadUsers()
{
    ...
    // Instead of fscanf, fgets can be used to read entire line as a string
    // fgets handles spaces and commas easily than fscanf
    ...
    // Other than this we can also tokenize the string after using fgets and then process them,
